...
HD_PWD='E:/Xilinx/my-alu/my-alu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_3_c.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab1_3_c.tcl -notrace
