...
HD_PWD='E:/Xilinx/my-alu/my-alu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_3_c.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1_3_c.tcl
